...
if st.session_state.user is None:
    ...
    # Left brand panel rendered as real HTML via components
...
<div style="min-height:100vh;padding:3rem;display:flex;flex-direction:column;justify-content:space-between;position:relative;overflow:hidden;">
  ...
  <div style="position:relative;z-index:1;">
    <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:3rem;">
      ...
      <h1 style="font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:1.6rem;letter-spacing:-0.02em;color:#3fff8b;">WealthIntel</h1>
    </div>
...
""", height=700, scrolling=False)
    ...
    # Right form panel — Streamlit widgets in a column
    ...
    with right_col:
        ...
        with auth_tab1:
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.5rem;">
              <button style="display:flex;align-items:center;justify-content:center;gap:0.5rem;padding:0.75rem;background:#1e2021;border:1px solid rgba(71,72,73,0.1);border-radius:0.5rem;color:#fff;font-family:'Inter',sans-serif;font-size:0.75rem;cursor:pointer;">
            ...
            <div style="padding:1rem;background:rgba(63,255,139,0.05);border:1px solid rgba(63,255,139,0.1);border-radius:0.5rem;display:flex;align-items:flex-start;gap:0.75rem;">
              <span style="color:#3fff8b;font-size:1.2rem;flex-shrink:0;">✓</span>
              <div>
                ...
                <p style="font-family:'Inter',sans-serif;font-size:0.75rem;color:#ababac;line-height:1.5;">Start your 14-day trial of Alpha-Tier models. No credit card required.</p>
              </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        <div style="margin-top:2rem;padding:2rem 0;border-top:1px solid #252627;text-align:center;">
          <div style="font-family:'Space Grotesk',sans-serif;font-weight:700;color:#3fff8b;font-size:1rem;margin-bottom:0.4rem;">WealthIntel</div>
          <div style="font-family:'Inter',sans-serif;font-size:0.68rem;color:#ababac;margin-bottom:1rem;">© 2024 WealthIntel. All rights reserved.</div>

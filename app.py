...
<div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.25em;text-transform:uppercase;color:#4a5a6a;margin-bottom:.6rem;">Institutional-grade analysis &amp; Free &amp; open</div>
<div style="font-family:'IBM Plex Mono',monospace;font-size:2rem;font-weight:700;color:#e8edf2;letter-spacing:.06em;line-height:1.2;">STOCK<span style="color:#00d4a0;">CAST</span></div>
<div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.9rem;color:#8a9bb0;margin-top:.5rem;max-width:520px;margin-left:auto;margin-right:auto;line-height:1.6;">Enter any NYSE / NASDAQ ticker in the sidebar and press <span style="color:#00d4a0;font-family:'IBM Plex Mono',monospace;font-weight:600;">&#9654; RUN FORECAST</span> to generate a full ML-powered market intelligence report.</div>
</div>
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin-bottom:2rem;">

<div style="background:#0f1318;border:1px solid #1e2a38;border-top:2px solid #00d4a0;padding:1.3rem 1.4rem;"><div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.18em;text-transform:uppercase;color:#00d4a0;margin-bottom:.5rem;">📈 XGBoost Forecast</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.82rem;color:#8a9bb0;line-height:1.5;">ML model trained on 20 technical features + lag windows. Predicts next <em>N</em> days with full 95% bootstrap confidence intervals.</div></div>
<div style="background:#0f1318;border:1px solid #1e2a38;border-top:2px solid #3d9eff;padding:1.3rem 1.4rem;"><div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.18em;text-transform:uppercase;color:#3d9eff;margin-bottom:.5rem;">⚙ Technical Signals</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.82rem;color:#8a9bb0;line-height:1.5;">RSI, MACD, Bollinger Bands, MA50/200, ATR, Volume Ratio — all computed live. BUY / SELL / HOLD signals generated from model predictions.</div></div>
<div style="background:#0f1318;border:1px solid #1e2a38;border-top:2px solid #ffd32a;padding:1.3rem 1.4rem;"><div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.18em;text-transform:uppercase;color:#ffd32a;margin-bottom:.5rem;">📊 Backtesting Engine</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.82rem;color:#8a9bb0;line-height:1.5;">Simulate your strategy on historical data. Get Sharpe ratio, max drawdown, win rate, profit factor, and full equity curve vs buy-and-hold.</div></div>
<div style="background:#0f1318;border:1px solid #1e2a38;border-top:2px solid #ff4757;padding:1.3rem 1.4rem;"><div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.18em;text-transform:uppercase;color:#ff4757;margin-bottom:.5rem;">🔬 Model Comparison</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.82rem;color:#8a9bb0;line-height:1.5;">Benchmark XGBoost against Prophet and Linear Regression side-by-side. RMSE, MAE, MAPE and R² reported for every model.</div></div>
<div style="background:#0f1318;border:1px solid #1e2a38;border-top:2px solid #00d4a0;padding:1.3rem 1.4rem;"><div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.18em;text-transform:uppercase;color:#00d4a0;margin-bottom:.5rem;">☪ Shariah Screening</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.82rem;color:#8a9bb0;line-height:1.5;">Automated Halal compliance check based on AAOIFI Standard No.21. Screens business activity, debt ratios, and cash ratios instantly.</div></div>
<div style="background:#0f1318;border:1px solid #1e2a38;border-top:2px solid #3d9eff;padding:1.3rem 1.4rem;"><div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.18em;text-transform:uppercase;color:#3d9eff;margin-bottom:.5rem;">⬇ Export Reports</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.82rem;color:#8a9bb0;line-height:1.5;">Download historical data + indicators, buy/sell signal log, forecast prices, and full trade history as CSV — ready for your own analysis.</div></div>
</div>
<div style="background:#0f1318;border:1px solid #1e2a38;border-left:3px solid #00d4a0;padding:1.4rem 1.8rem;margin-bottom:2rem;">
<div style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;letter-spacing:.18em;text-transform:uppercase;color:#4a5a6a;margin-bottom:.8rem;">How it works</div>
<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;">
<div style="text-align:center;"><div style="font-family:'IBM Plex Mono',monospace;font-size:1.4rem;color:#00d4a0;font-weight:700;">01</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.75rem;color:#8a9bb0;margin-top:.3rem;">Historical OHLCV data fetched via yfinance (up to 7 years)</div></div>
<div style="text-align:center;"><div style="font-family:'IBM Plex Mono',monospace;font-size:1.4rem;color:#00d4a0;font-weight:700;">02</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.75rem;color:#8a9bb0;margin-top:.3rem;">20 technical indicators engineered as model features</div></div>
<div style="text-align:center;"><div style="font-family:'IBM Plex Mono',monospace;font-size:1.4rem;color:#00d4a0;font-weight:700;">03</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.75rem;color:#8a9bb0;margin-top:.3rem;">XGBoost trained on 80% of data, evaluated on held-out 20%</div></div>
<div style="text-align:center;"><div style="font-family:'IBM Plex Mono',monospace;font-size:1.4rem;color:#00d4a0;font-weight:700;">04</div><div style="font-family:'IBM Plex Sans',sans-serif;font-size:0.75rem;color:#8a9bb0;margin-top:.3rem;">Bootstrap CI quantifies forecast uncertainty across all predictions</div></div>
</div>
</div>
<div style="text-align:center;">
<div style="font-family:'IBM Plex Mono',monospace;font-size:0.7rem;color:#2a3a4e;letter-spacing:.1em;margin-bottom:.5rem;">AAPL · TSLA · GOOGL · MSFT · AMZN · NFLX · META · NVDA · JPM · AMD · ORCL · BABA</div>
<div style="font-family:'IBM Plex Mono',monospace;font-size:0.62rem;color:#1e2a38;letter-spacing:.08em;">⚠ For educational purposes only. Not financial advice. Past model performance does not guarantee future results.</div>
</div>
</div>
""", unsafe_allow_html=True)

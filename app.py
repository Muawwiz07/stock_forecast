...
if st.session_state.user is None:
    ...
    # ── Full-page split layout rendered as a single HTML component ────────────
    # Left brand panel is pure HTML (no Streamlit widgets needed there).
    # Right form panel uses a narrow Streamlit column so inputs/buttons work.

    _auth_components.html("""
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
...
@keyframes sc-pulse { 0%,100%{opacity:1;box-shadow:0 0 0 0 rgba(63,255,139,0.4);} 50%{opacity:.7;box-shadow:0 0 0 6px rgba(63,255,139,0);} }
</style>
</head>
<body>
<div style="min-height:100vh;padding:3rem;display:flex;flex-direction:column;justify-content:space-between;position:relative;overflow:hidden;">
  ...
  <!-- Ambient glows -->
  <div style="position:absolute;top:20%;left:-6rem;width:26rem;height:26rem;background:rgba(63,255,139,0.07);filter:blur(90px);border-radius:50%;pointer-events:none;"></div>
  <div style="position:absolute;bottom:15%;right:-6rem;width:22rem;height:22rem;background:rgba(69,254,201,0.04);filter:blur(80px);border-radius:50%;pointer-events:none;"></div>

  <!-- Top: Logo + Tagline -->
  <div style="position:relative;z-index:1;">
    <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:3rem;">
      <span class="material-symbols-outlined" style="color:#3fff8b;font-size:2.2rem;">insights</span>
      <h1 style="font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:1.6rem;letter-spacing:-0.02em;color:#3fff8b;">Stockcast Terminal</h1>
    </div>
    <h2 style="font-family:'Space Grotesk',sans-serif;font-size:2.4rem;font-weight:500;line-height:1.2;color:#ffffff;margin-bottom:1.2rem;">
      Predicting the pulse of<br>global markets.
    </h2>
  ...
  <!-- Bottom: Live Alpha Stream card -->
  <div style="position:relative;z-index:1;background:#252627;padding:1.5rem;border-radius:4px;border:1px solid rgba(71,72,73,0.15);">
    ...
    <div style="height:8rem;background:#000;border-radius:2px;overflow:hidden;display:flex;align-items:flex-end;padding:0.5rem;gap:4px;">
...
""", height=700, scrolling=False)
    ...
    # ── RIGHT: Form Panel (Streamlit widgets) ──────────────────────────────────
    ...
    with right_col:
        ...
        # Footer
        st.markdown("""
        <div style="margin-top:2rem;padding:2rem 0;border-top:1px solid #252627;text-align:center;">
          <div style="font-family:'Space Grotesk',sans-serif;font-weight:700;color:#3fff8b;font-size:1rem;margin-bottom:0.4rem;">Stockcast Terminal</div>
          <div style="font-family:'Inter',sans-serif;font-size:0.68rem;color:#ababac;margin-bottom:1rem;">© 2024 Stockcast Terminal. All rights reserved.</div>
          <div style="display:flex;gap:1.5rem;justify-content:center;flex-wrap:wrap;margin-bottom:1rem;">
            <a href="#" style="font-family:'Inter',sans-serif;font-size:0.68rem;color:#ababac;text-decoration:none;">Terms of Service</a>
            <a href="#" style="font-family:'Inter',sans-serif;font-size:0.68rem;color:#ababac;text-decoration:none;">Privacy Policy</a>
            <a href="#" style="font-family:'Inter',sans-serif;font-size:0.68rem;color:#ababac;text-decoration:none;">API Documentation</a>
            <a href="#" style="font-family:'Inter',sans-serif;font-size:0.68rem;color:#ababac;text-decoration:none;">Support</a>
          </div>
          <div style="font-family:'Inter',sans-serif;font-size:0.58rem;color:#474849;letter-spacing:0.08em;">
